...
def main(WEIGHT_DECAY, WARMUP_RATIO, NUM_TRAIN_EPOCHS, ONLY_UPTO, OUTPUT_DIR, DATASET,
         BATCH_SIZE, model_checkpoint, speaker_mode, num_past_utterances, num_future_utterances, N_TRIALS, **kwargs):
    ...
    best_run = trainer.hyperparameter_search(
        direction="minimize", hp_space=my_hp_space, n_trials=N_TRIALS)
