...
TOTAL_NUM_UPDATES=12500                                # one epoch is around 160 updates for MELD, when MAX_SENTENCES=8 and UPDATE_FREQ=4
WARMUP_UPDATES=2500                                    # 20 percent of the number of updates
