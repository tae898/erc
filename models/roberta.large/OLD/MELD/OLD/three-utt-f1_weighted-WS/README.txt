...
Speakers are NOT prepended
Three utterances are chosen that in a row.
...
For example:
<s>Haven't seen you in a while! Hi how are you?</s></s>You wanna go for a drink?</s>
...
<s>'  '</s></s>Haven't seen you in a while!</s>
